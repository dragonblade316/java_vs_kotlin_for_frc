...
{
    private val left_joy =Joystick(0)
    private val right_joy = Joystick(1)

    val Driver = DriverCommand(left_joy, right_joy)
    val drive_subsystem = DriverSubsystem
    ...
    init
    {
        drive_subsystem.setDefaultCommand(Driver)
